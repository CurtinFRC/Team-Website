        ...
        <div className='hero'>
          ...
          <div className="column" id="gold-sponsors">
            <SponsorCategory title="Gold Sponsors">
              ...
              <img src='artifactory.png' alt='artifactory' height={100} width={300} />
              <p>The Perth Artifactory is the Hackerspace/Makerspace in Perth, Western Australia.</p>
          ...
          <div className="column" id="silver-sponsors">
            <SponsorCategory title="Silver Sponsors">
              ...
              <p>Rockwell Automation, Inc. is an American provider of industrial automation and digital transformation technologies.</p>
              <img src='curry.png' alt='curry curry curry' height={100} width={300} />
              <p>Traditional Indian plates served in a mellow locale with a display of grab-&-go snacks & desserts.</p>
              <img src='arabia.webp' alt='arab association' height={163} width={170} />
              <p>
